    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-in slide-in-from-bottom-4 duration-500 pb-20">
      ...
      <div className="flex justify-center">
        <button
          ...
          className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-300 px-6 py-2 rounded-full font-bold text-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition-all shadow-sm flex items-center gap-2"
        >
          {showHistoryList ? (
            <>
              <i className="fa-solid fa-calendar-week"></i> Back to Weekly View
            </>
          ) : (
            <>
              <i className="fa-solid fa-list-check"></i> View Full History
            </>
          )}
        </button>
      </div>
