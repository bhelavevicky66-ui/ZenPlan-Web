            ...
            <div className="bg-white rounded-[2rem] p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="text-xs font-bold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-md">{yesterdayStr}</span>
                </div>
                <h4 className="text-lg font-bold text-slate-800 mb-6">Past Performance</h4>
                
                <div className="space-y-4">
                   <div className="flex justify-between items-end">
                      <div className="flex flex-col">
                        <span className="text-[9px] font-black text-emerald-600">DONE</span>
                        <span className="text-2xl font-black text-slate-800">{yesterdayStats.done}%</span>
                      </div>
                      <div className="flex flex-col items-end">
                        <span className="text-[9px] font-black text-rose-500">FAILED</span>
                        <span className="text-2xl font-black text-slate-800">{yesterdayStats.fail}%</span>
                      </div>
                   </div>
              ...
              <div className="mt-6 pt-4 border-t border-slate-50 text-[10px] text-slate-400 font-bold">
        ...
        <div className="bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm hover:shadow-md transition-shadow flex flex-col items-center justify-center text-center">
            ...
            <div className="relative w-48 h-48 mb-6">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-3xl font-black text-slate-800">{todayStats.done}%</span>
            ...
            <div className="flex gap-8 w-full justify-center">
                <div className="text-center">
                    <div className="text-2xl font-black text-emerald-600">{todayStats.done}%</div>
